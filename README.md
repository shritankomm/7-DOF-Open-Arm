...
Full step-by-step assembly instructions can be found in instructions.md. Follow along via the build journal in /journal to track design decisions and progress in the meantime.
